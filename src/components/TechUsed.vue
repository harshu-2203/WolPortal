<template>
    <section id="technologies" class="mt-6">
        <h3 class="text-lg text-gray-400 dark:text-neutral-700 px-4 uppercase font-poppin font-bold ">
            Technologies I use</h3>
        <div class="flex flex-col space-y-6 mt-8">
            <section>
                <h5 class="border-b border-gray-400/10 dark:border-neutral-600/10 text-gray-400 dark:text-neutral-600/70 text-lg mx-4 mb-4 pb-2 font-medium"
                   >
                    Development
                </h5>
                <div class="grid px-4 md:grid-cols-3 grid-cols-1 lg:grid-cols-4 gap-x-2 gap-y-2">
                    <div
                        class="dark:bg-neutral-600/10 bg-gray-100 hover:bg-wolblack text-black/50 rounded-md cursor-pointer select-none transition-colors p-3 flex items-center space-x-2 overflow-hidden dark:hover:bg-neutral-600/15 text-white">
                        <div class="p-2 rounded-lg flex ring-1 ring-black/5 items-center justify-center"
                            style="background-color: rgba(243, 218, 53, 0.125);">

                            <svg style="color: #f3da35" xmlns="http://www.w3.org/2000/svg" width="512" height="512" class="flex-shrink-0 h-5 w-5" viewBox="0 0 512 512"><title>js</title><path d="M32,32V480H480V32ZM272,380c0,43.61-25.76,64.87-63.05,64.87-33.68,0-53.23-17.44-63.15-38.49h0l34.28-20.75c6.61,11.73,11.63,21.65,26.06,21.65,12,0,21.86-5.41,21.86-26.46V240h44Zm99.35,63.87c-39.09,0-64.35-17.64-76.68-42h0L329,382c9,14.74,20.75,24.56,41.5,24.56,17.44,0,27.57-7.72,27.57-19.75,0-14.43-10.43-19.54-29.68-28l-10.52-4.52c-30.38-12.92-50.52-29.16-50.52-63.45,0-31.57,24.05-54.63,61.64-54.63,26.77,0,46,8.32,59.85,32.68L396,290c-7.22-12.93-15-18-27.06-18-12.33,0-20.15,7.82-20.15,18,0,12.63,7.82,17.74,25.86,25.56l10.52,4.51c35.79,15.34,55.94,31,55.94,66.16C441.12,424.13,411.35,443.87,371.35,443.87Z" fill="#f3da35"></path></svg>
                        
                        
                        
                        
                        </div> <span class="flex-1 dark:text-neutral-500 truncate">JavaScript</span>
                    </div>
                    <div
                        class="dark:bg-neutral-600/10 bg-gray-100 hover:bg-wolblack text-black/50 rounded-md cursor-pointer select-none transition-colors p-3 flex items-center space-x-2 overflow-hidden dark:hover:bg-neutral-600/15 text-white">
                        <div class="p-2 rounded-lg flex ring-1 ring-black/5 items-center justify-center"
                            style="background-color: rgba(66, 184, 131, 0.125);"><svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512" class="flex-shrink-0 h-5 w-5">
                                ...
                                <path d="M409.4 47.92L256 313.61 102.6 47.92H15.74L256 464.08 496.26 47.92H409.4z"
                                    fill="#41B883"></path>
                            </svg></div> <span class="flex-1 dark:text-neutral-500 truncate">Vue.js</span>
                    </div>
                    <div
                        class="dark:bg-neutral-600/10 bg-gray-100 hover:bg-wolblack text-black/50 rounded-md cursor-pointer select-none transition-colors p-3 flex items-center space-x-2 overflow-hidden dark:hover:bg-neutral-600/15 text-white">
                        <div class="p-2 rounded-lg flex ring-1 ring-black/5 items-center justify-center"
                            style="background-color: rgba(97, 218, 251, 0.125);"><svg viewBox="0 0 25 25" fill="none"
                                xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 h-5 w-5">
                            ...
                            </svg></div> <span class="flex-1 dark:text-neutral-500 truncate">React.js</span>
                    </div>
                    <div
                        class="dark:bg-neutral-600/10 bg-gray-100 hover:bg-wolblack text-black/50 rounded-md cursor-pointer select-none transition-colors p-3 flex items-center space-x-2 overflow-hidden dark:hover:bg-neutral-600/15 text-white">
                        <div class="p-2 rounded-lg flex ring-1 ring-black/5 items-center justify-center"
                            style="background-color: rgba(227, 76, 38, 0.063);"><svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 512 512" fill="#dd4b25" class="flex-shrink-0 h-5 w-5">
                                <path
                            ...
                            </svg></div> <span class="flex-1 dark:text-neutral-500 truncate">HTML5</span>
                    </div>
                    <div
                        class="dark:bg-neutral-600/10 bg-gray-100 hover:bg-wolblack text-black/50 rounded-md cursor-pointer select-none transition-colors p-3 flex items-center space-x-2 overflow-hidden dark:hover:bg-neutral-600/15 text-white">
                        <div class="p-2 rounded-lg flex ring-1 ring-black/5 items-center justify-center"
                            style="background-color: rgba(56, 178, 172, 0.125);"><svg viewBox="0 0 24 24" fill="none"
                                xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 h-5 w-5">
                            ...
                            </svg></div> <span class="flex-1 dark:text-neutral-500 truncate">Tailwind CSS</span>
                    </div>
                    <div
                        class="dark:bg-neutral-600/10 bg-gray-100 hover:bg-wolblack text-black/50 rounded-md cursor-pointer select-none transition-colors p-3 flex items-center space-x-2 overflow-hidden dark:hover:bg-neutral-600/15 text-white">
                        <div class="p-2 rounded-lg flex ring-1 ring-black/5 items-center justify-center"
                            style="background-color: rgba(51, 153, 51, 0.125);"><svg xmlns="http://www.w3.org/2000/svg"
                                fill="#6FA660" viewBox="0 0 512 512" class="flex-shrink-0 h-5 w-5">
                                <path
                            ...
                            </svg></div> <span class="flex-1 dark:text-neutral-500 truncate">Node.js</span>
                    </div>
                    <div
                        class="dark:bg-neutral-600/10 bg-gray-100 hover:bg-wolblack text-black/50 rounded-md cursor-pointer select-none transition-colors p-3 flex items-center space-x-2 overflow-hidden dark:hover:bg-neutral-600/15 text-white">
                        <div class="p-2 rounded-lg flex ring-1 ring-black/5 items-center justify-center"
                            style="background-color: rgba(207, 100, 154, 0.063);"><svg
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" fill="#cf649a"
                            ...
                            </svg></div> <span class="flex-1 dark:text-neutral-500 truncate">Sass</span>
                    </div>
                </div>
            </section>
            <section>
                ...
                <div class="grid px-4 md:grid-cols-3 grid-cols-1 lg:grid-cols-4 gap-x-2 gap-y-2">
                    <div
                        class="dark:bg-neutral-600/10 bg-gray-100 hover:bg-wolblack text-black/50 rounded-md cursor-pointer select-none transition-colors p-3 flex items-center space-x-2 overflow-hidden dark:hover:bg-neutral-600/15 text-white">
                        <div class="p-2 rounded-lg flex ring-1 ring-black/5 items-center justify-center"
                            style="background-color: rgba(1, 101, 169, 0.125);"><svg viewBox="0 0 100 100" fill="none"
                                xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 h-5 w-5">
                                ...
                                <g mask="url(#prefix__a)">
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        fill="url(#prefix__paint0_linear)" opacity=".25"></path>
                                </g>
                                <defs>
            ...
            <section>
                ...
                <div class="grid px-4 md:grid-cols-3 grid-cols-1 lg:grid-cols-4 gap-x-2 gap-y-2">
                    <div
                        class="dark:bg-neutral-600/10 bg-gray-100 hover:bg-wolblack text-black/50 rounded-md cursor-pointer select-none transition-colors p-3 flex items-center space-x-2 overflow-hidden dark:hover:bg-neutral-600/15 text-white">
                        <div class="p-2 rounded-lg flex ring-1 ring-black/5 items-center justify-center"
                            style="background-color: rgba(232, 234, 234, 0.063);"><svg
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="flex-shrink-0 h-5 w-5">
                                <path
                                    ...
                                    class="fill-black/75 dark:fill-white/90"></path>
                            </svg></div> <span class="flex-1 dark:text-neutral-500 truncate">GitHub</span>
                    </div>
                    <div
                        class="dark:bg-neutral-600/10 bg-gray-100 hover:bg-wolblack text-black/50 rounded-md cursor-pointer select-none transition-colors p-3 flex items-center space-x-2 overflow-hidden dark:hover:bg-neutral-600/15 text-white">
                        <div class="p-2 rounded-lg flex ring-1 ring-black/5 items-center justify-center"
                            style="background-color: rgba(255, 202, 40, 0.125);"><svg viewBox="0 0 32 32"
                                xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 h-5 w-5">
                                <path fill="#ffc24a"
                                    d="M5.8 24.6l.17-.237 8.02-15.214.017-.161-3.535-6.64a.656.656 0 00-1.227.207z">
                                </path>
                                <path fill="#ffa712"
                                    d="M5.9 24.42l.128-.25 7.937-15.056-3.526-6.666a.6.6 0 00-1.133.206z"></path>
                                <path fill="#f4bd62"
                            ...
                            </svg></div> <span class="flex-1 dark:text-neutral-500 truncate">Firebase</span>
                    </div>
                    <div
                        class="dark:bg-neutral-600/10 bg-gray-100 hover:bg-wolblack text-black/50 rounded-md cursor-pointer select-none transition-colors p-3 flex items-center space-x-2 overflow-hidden dark:hover:bg-neutral-600/15 text-white">
                        <div class="p-2 rounded-lg flex ring-1 ring-black/5 items-center justify-center"
                            style="background-color: rgba(0, 199, 183, 0.125);"><svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 40 40" class="flex-shrink-0 h-5 w-5">
                                <path
                                    ...
                                    class="fill-black/75 dark:fill-white/90"></path>
                            </svg></div> <span class="flex-1 dark:text-neutral-500 truncate">Netlify</span>
                    </div>
                </div>
            </section>
        </div>
