<template>
    <section id="technologies" class="mt-6">
        <h3 class="text-lg text-neutral-700 px-4 uppercase font-poppin font-bold ">
            Technologies I use</h3>
        <div class="flex flex-col space-y-6 mt-8">
            <section>
                <h5 class="border-b  border-neutral-600/10 text-neutral-600/70 text-lg mx-4 mb-4 pb-2 font-medium"
                   >
                    Development
                </h5>
                <div class="grid px-4 md:grid-cols-3 grid-cols-1 lg:grid-cols-4 gap-x-2 gap-y-2">
                    <div
                        class="bg-neutral-600/10 hover:bg-wolblack text-black/50 rounded-md cursor-pointer select-none transition-colors p-3 flex items-center space-x-2 overflow-hidden hover:bg-neutral-600/15 text-white">
                        ...
                        </div> <span class="flex-1 text-neutral-500 truncate">JavaScript</span>
                    </div>
                    <div
                        class="bg-neutral-600/10  hover:bg-wolblack text-black/50 rounded-md cursor-pointer select-none transition-colors p-3 flex items-center space-x-2 overflow-hidden hover:bg-neutral-600/15 text-white">
                        <div class="p-2 rounded-lg flex ring-1 ring-black/5 items-center justify-center"
                            style="background-color: rgba(66, 184, 131, 0.125);"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <path d="M409.4 47.92L256 313.61 102.6 47.92H15.74L256 464.08 496.26 47.92H409.4z"
                                    fill="#41B883"></path>
                            </svg></div> <span class="flex-1 text-neutral-500 truncate">Vue.js</span>
                    </div>
                    <div
                        class="bg-neutral-600/10  hover:bg-wolblack text-black/50 rounded-md cursor-pointer select-none transition-colors p-3 flex items-center space-x-2 overflow-hidden hover:bg-neutral-600/15 text-white">
                        <div class="p-2 rounded-lg flex ring-1 ring-black/5 items-center justify-center"
                            ...
                            </svg></div> <span class="flex-1 text-neutral-500 truncate">React.js</span>
                    </div>
                    <div
                        class="bg-neutral-600/10  hover:bg-wolblack text-black/50 rounded-md cursor-pointer select-none transition-colors p-3 flex items-center space-x-2 overflow-hidden hover:bg-neutral-600/15 text-white">
                        <div class="p-2 rounded-lg flex ring-1 ring-black/5 items-center justify-center"
                            ...
                            </svg></div> <span class="flex-1 text-neutral-500 truncate">HTML5</span>
                    </div>
                    <div
                        class="bg-neutral-600/10  hover:bg-wolblack text-black/50 rounded-md cursor-pointer select-none transition-colors p-3 flex items-center space-x-2 overflow-hidden hover:bg-neutral-600/15 text-white">
                        <div class="p-2 rounded-lg flex ring-1 ring-black/5 items-center justify-center"
                            ...
                            </svg></div> <span class="flex-1 text-neutral-500 truncate">Tailwind CSS</span>
                    </div>
                    <div
                        class="bg-neutral-600/10  hover:bg-wolblack text-black/50 rounded-md cursor-pointer select-none transition-colors p-3 flex items-center space-x-2 overflow-hidden hover:bg-neutral-600/15 text-white">
                        <div class="p-2 rounded-lg flex ring-1 ring-black/5 items-center justify-center"
                            ...
                            </svg></div> <span class="flex-1 text-neutral-500 truncate">Node.js</span>
                    </div>
                    <div
                        class="bg-neutral-600/10  hover:bg-wolblack text-black/50 rounded-md cursor-pointer select-none transition-colors p-3 flex items-center space-x-2 overflow-hidden hover:bg-neutral-600/15 text-white">
                        <div class="p-2 rounded-lg flex ring-1 ring-black/5 items-center justify-center"
                            ...
                            </svg></div> <span class="flex-1 text-neutral-500 truncate">Sass</span>
                    </div>
                </div>
            </section>
            <section>
                        ...
                        <div class="p-2 rounded-lg flex ring-1 ring-black/5 items-center justify-center"
                            style="background-color: rgba(242, 78, 30, 0.063);"><svg viewBox="0 0 20 20" fill="none"
                                ...
                                <path
                                    ...
                                    fill="#1ABCFE"></path>
                            </svg></div> <span class="flex-1 text-neutral-500 truncate">Figma</span>
                    </div>
                </div>
            </section>
            <section>
                        ...
                        <div class="p-2 rounded-lg flex ring-1 ring-black/5 items-center justify-center"
                            style="background-color: rgba(232, 234, 234, 0.063);"><svg
                                ...
                                <path
                                    ...
                                    class=" fill-white/90"></path>
                            </svg></div> <span class="flex-1 text-neutral-500 truncate">GitHub</span>
                    </div>
                    <div
                        class="bg-neutral-600/10  hover:bg-wolblack text-black/50 rounded-md cursor-pointer select-none transition-colors p-3 flex items-center space-x-2 overflow-hidden hover:bg-neutral-600/15 text-white">
                        <div class="p-2 rounded-lg flex ring-1 ring-black/5 items-center justify-center"
                            ...
                            </svg></div> <span class="flex-1 text-neutral-500 truncate">Firebase</span>
                    </div>
                    <div
                        class="bg-neutral-600/10  hover:bg-wolblack text-black/50 rounded-md cursor-pointer select-none transition-colors p-3 flex items-center space-x-2 overflow-hidden text-white">
                        <div class="p-2 rounded-lg flex ring-1 ring-black/5 items-center justify-center"
                            style="background-color: rgba(0, 199, 183, 0.125);"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <path
                                    ...
                                    class="fill-white/90 "></path>
                            </svg></div> <span class="flex-1 text-neutral-500 truncate">Netlify</span>
                    </div>
                </div>
            </section>
        </div>
